...
// Bubble Sort
vector<Complaint> bubbleSort(vector<Complaint> arr, string key = "createdAt",
                             string order = "desc") {
  int n = arr.size();
  for (int i = 0; i < n; i++) {
...
// Insertion Sort
vector<Complaint> insertionSort(vector<Complaint> arr, string key = "createdAt",
                                string order = "desc") {
...
// Selection Sort
vector<Complaint> selectionSort(vector<Complaint> arr, string key = "createdAt",
                                string order = "desc") {
  int n = arr.size();
  for (int i = 0; i < n - 1; i++) {
    int idx = i;
...
// Compare IDs
int compareIds(string a, string b) { return stoi(a) - stoi(b); }
